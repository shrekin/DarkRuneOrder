...
local closeBtn = CreateFrame("Button", nil, pickerFrame)
closeBtn:SetSize(24, 24)
closeBtn:SetPoint("TOPRIGHT", pickerFrame, "TOPRIGHT", -8, -8)
local closeTex = closeBtn:CreateTexture(nil, "ARTWORK")
closeTex:SetAllPoints()
closeTex:SetTexture("Interface\\AddOns\\DarkRuneOrder\\icons\\close-popup-4.png")
closeBtn:SetScript("OnClick", function() pickerFrame:Hide() end)
closeBtn:SetScript("OnEnter", function() closeTex:SetAlpha(0.7) end)
...
centerDot:SetPoint("CENTER", pickerFrame, "CENTER", 0, 32)
...
for i, sym in ipairs(DarkRuneOrder.Symbols) do
    ...
    btn:SetSize(44, 44)
    btn:SetPoint("CENTER", pickerFrame, "CENTER", positions[i].x, positions[i].y + 32)
